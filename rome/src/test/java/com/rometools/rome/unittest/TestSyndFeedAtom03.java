...
public class TestSyndFeedAtom03 extends SyndFeedTest {
    ...
    public void testPublishedDate() throws Exception {
        final ZonedDateTime d = DateParser.parseW3CDateTime("2000-01-01T00:00:00Z", Locale.US);
    ...
    protected void testEntry(final int i) throws Exception {
        ...
        final ZonedDateTime d = DateParser.parseW3CDateTime("2000-0" + (i + 1) + "-01T00:00:00Z", Locale.US);
